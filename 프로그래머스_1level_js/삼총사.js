 ...
 * 세 학생도 삼총사입니다. 따라서 이 경우 한국중학교에서는 두 가지 방법으로 
 * 삼총사를 만들 수 있습니다.
 * 
 ...
 * ex1) 문제 예시와 같습니다.
 * 
 * ex2) 학생들의 정수 번호 쌍 (-3, 0, 3), (-2, 0, 2), (-1, 0, 1), 
 *      (-2, -1, 3), (-3, 1, 2) 이 삼총사가 될 수 있으므로, 5를 return 합니다.
 * 
 * ex3) 삼총사가 될 수 있는 방법이 없습니다.
 * 
 */
 ...
 * 문제 해석
 * 
 * 재귀함수를 사용해서 백트레킹 알고리즘을 이용해야 한다.
 * 
 * 가능한 모든 조합을 생성해서 합이 0이 되는 경우만 카운트 한다.
 * 
 * 번호 중복은 막아야 한다.
 * 
 */
